...
var PriorityNavScroller = function PriorityNavScroller() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      scrollStep = 75;//'average'; //_ref$scrollStep === undefined ? 75 : _ref$scrollStep;
  ...
  var getOverflow = function getOverflow() {
    ...
    var scrollLeft = $('.nav-scroller-nav').scrollLeft();  //navScrollerNav.scrollLeft;


    if (scrollLeft == 0) {
        switch(jQuery.support.rtlScrollType) {
            case "negative":
                scrollLeft =  scrollLeft + scrollWidth - scrollViewport;
            case "reverse":
                scrollLeft = scrollWidth - scrollLeft  - scrollViewport;
        }
    }
